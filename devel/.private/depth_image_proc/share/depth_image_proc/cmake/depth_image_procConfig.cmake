...
if("TRUE" STREQUAL "TRUE")
  set(depth_image_proc_SOURCE_PREFIX /home/amr/asu_swarm_gp19/src/image_pipeline/depth_image_proc)
  set(depth_image_proc_DEVEL_PREFIX /home/amr/asu_swarm_gp19/devel/.private/depth_image_proc)
  ...
  set(depth_image_proc_INSTALL_PREFIX /home/amr/asu_swarm_gp19/install)
...
if(NOT "/home/amr/asu_swarm_gp19/src/image_pipeline/depth_image_proc/include " STREQUAL " ")
  set(depth_image_proc_INCLUDE_DIRS "")
  set(_include_dirs "/home/amr/asu_swarm_gp19/src/image_pipeline/depth_image_proc/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'depth_image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/amr/asu_swarm_gp19/src/image_pipeline/depth_image_proc/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/amr/asu_swarm_gp19/devel/.private/depth_image_proc/lib;/home/amr/asu_swarm_gp19/devel/lib;/opt/ros/kinetic/lib)
